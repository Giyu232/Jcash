...
public class UserCtl {
    ...
    public UserCtl(Transaction transaction, UserService userService, Transfer transfer) {
        ...
        try{
            ...
            do{
                ...
                if(check){
                    ...
                    this.transaction.getTransactionsByUserID(this.userService.getCurrentUserId());
    ...
    public void cashIn() {
        ...
        try{
            ...
            if(answer.equalsIgnoreCase("Y")){
                ...
                if(check){
                    transaction.addTransaction("DEPOSIT", amount, "CASH-IN", Date.valueOf(LocalDate.now()), this.userService.getCurrentUserId());
    ...
    public void transferMoney() {
        ...
        try{
            ...
            if(answer.equalsIgnoreCase("Y")){
                this.transfer.updateSenderAndReceiverBalance(mobileNumber, amount);
            }
        }catch (Exception e){
            throw new RuntimeException(e);
        }
    ...
    public void displayTransactionLogs() {
        try{
            List<TransactionMdl> transactionMdls = this.transaction.getTransactions();
            System.out.println("View Transaction");
            System.out.println("Transaction Type | Amount | Details | Date");
            for(TransactionMdl transactionMdl : transactionMdls) {
                System.out.println(transactionMdl);
            }
        }catch (Exception e){
            throw new RuntimeException(e);
        }
